import re
# Source: https://github.com/ian-beaver/pycontractions/blob/master/pycontractions/contractions.py
# May 27, 2019 at 6:23:48 PM
simple_contractions = {
    ...
    re.compile(r"\bwe're\b", re.I | re.U): "we are", # diff from source. May 27, 2019 at 7:12:07 PM
    ...
    # Added on May 27, 2019 at 8:46:43 PM 
    re.compile(r"\bd'?you\b", re.I | re.U): "do you",
